...
class StickersMod(loader.Module):
	...
	strings = {"name": "Stickers",
	           ...
	           "what_pack": "<b>Введи куда хочешь спиздить стикер.</b>",
	           "what_photo": "<b>Реплай на стикер/фото которое хочешь спиздить.</b>",
	           "not_animated_pack": "<b>Обычный стикер не может быть добавлен в анимированный пак.</b>",
	           "internal_error": "<b>Что то помешало тебе спиздить стикер, смотри в 'logs error'.</b>",
	           "bad_emojis": "<b>Этот смайлик дал тебе ошибку.</b>",
	           "animated_pack": "<b>Анимированные стикеры не могут быть добавлены в не анимированные паки.</b>",
	           "new_pack": "<b>Создай стикерпак</b>",
	           "pack_full": "<b>Сэмпай, ты переполнил стикерпак но всё еще не остановился?</b>",
	           "added": "<b>Стикер был спизден в</b> <a href='{}'>Стикерпак</a><b>!</b>",
	           "bad_animated_sticker": "<b>Реплай на анимированный стикер, что б получить гифку.</b>"}
