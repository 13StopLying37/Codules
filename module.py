...
class GitaddMod(loader.Module):
    ...
    def __init__(self):
        self.config = loader.ModuleConfig("GH_TOKEN", "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", lambda m: self.strings("cfg_token", m),
            "GH_USERNAME", "13StopLying37", lambda m: self.strings("cfg_gh_user", m),
            "GH_REPO", "Codules", lambda m: self.strings("cfg_gh_repo", m))
